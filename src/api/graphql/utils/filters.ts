...
const AGENT_FILTERS: FilterConfig[] = [
  ...
  { graphqlField: 'agentid', dbColumn: 'global_id', operator: 'eq' },
  { graphqlField: 'agentid_gt', dbColumn: 'global_id', operator: 'gt' },
  { graphqlField: 'agentid_lt', dbColumn: 'global_id', operator: 'lt' },
  { graphqlField: 'agentid_gte', dbColumn: 'global_id', operator: 'gte' },
  { graphqlField: 'agentid_lte', dbColumn: 'global_id', operator: 'lte' },
