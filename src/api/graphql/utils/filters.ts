...
const AGENT_FILTERS: FilterConfig[] = [
  ...
  { graphqlField: 'globalId', dbColumn: 'global_id', operator: 'eq' },
  { graphqlField: 'globalId_gt', dbColumn: 'global_id', operator: 'gt' },
  { graphqlField: 'globalId_lt', dbColumn: 'global_id', operator: 'lt' },
  { graphqlField: 'globalId_gte', dbColumn: 'global_id', operator: 'gte' },
  { graphqlField: 'globalId_lte', dbColumn: 'global_id', operator: 'lte' },
